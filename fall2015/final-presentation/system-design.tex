...
\todo[inline]{This feels badly laid out and incompletely described.}
...
\todo[inline]{Citations? Is it actually Canakit? Ansible is for deployment
not really provisioning I think...We're not actually using vagrant. This
could probably be done better with a table, I think.}
