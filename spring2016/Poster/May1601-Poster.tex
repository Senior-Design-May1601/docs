...
\veryHuge \color{NavyBlue} \textbf{Alliant Energy SCADA Honeypot System} \color{Blue}\\ % Title
\Huge\textit{Network Security Device}\\[2cm] 
\color{Black} \huge \textbf{Team Members}\\[0.5cm]
\huge Aashwatth Agarwal, Dan Borgerding, Jon Hope, Nik Kinkel, Jon Osborne, Korbin Stich\\[0.4cm]
\huge\textbf{Advisor}\\[.5cm]
\huge Dr. Doug Jacobson 
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\includegraphics[width=10cm]{Alliant.jpg}\\
\end{minipage}
